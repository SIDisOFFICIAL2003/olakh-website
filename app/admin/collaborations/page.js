...
export default function AdminCollaborationsPage() {
  ...
  async function loadSubmissions() {
    ...
    if (fetchError) {
      ...
      setError("Could not load collaboration submissions.");
      setLoading(false);
      return;
    }
  ...
  async function deleteSubmission(id) {
    const confirmed = window.confirm(
      "Are you sure you want to delete this collaboration submission?"
    );
  ...
  const filteredSubmissions = submissions.filter((submission) => {
    ...
    return (
      ...
      submission.collaboration_type?.toLowerCase().includes(query) ||
      submission.proposal?.toLowerCase().includes(query)
    );
  });
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 md:py-20">
        ...
        <div className="flex flex-col justify-between gap-8 md:flex-row md:items-end">
          ...
          <div>
            ...
            <p className="mt-4 max-w-2xl text-lg leading-8 text-[#666]">
              Review collaboration proposals and manage conversations
              with organisations, filmmakers, researchers and community groups.
            </p>
        ...
        <div className="mt-12 rounded-2xl bg-white p-5 shadow-[0_10px_35px_rgba(21,2,151,0.05)]">
          ...
          <input
            ...
            placeholder="Search by name, organisation, email, city, type or proposal..."
        ...
        {loading && (
          <div className="mt-8 rounded-2xl bg-white p-12 text-center text-[#666]">
            Loading collaboration submissions...
          </div>
        )}
          ...
          filteredSubmissions.length === 0 && (
            ...
            <div className="mt-8 rounded-2xl border border-dashed border-[#150297]/15 bg-white p-12 text-center">
              ...
              <p className="text-[#666]">
                No collaboration submissions found.
              </p>
                ...
                <table className="w-full min-w-[1400px] border-collapse">
                  ...
                  <tbody>
                    ...
                    {filteredSubmissions.map((submission, index) => (
                      ...
                      <tr
                        key={submission.id}
                        className={`border-b border-[#150297]/10 transition hover:bg-[#F7F6FB] ${
                          index % 2 === 0
                            ? "bg-white"
                            : "bg-[#FBFAFD]"
                        }`}
                      >
                        ...
                        <td className="px-5 py-5 align-top">
                          ...
                          <span className="inline-flex rounded-full bg-[#311EB2]/10 px-3 py-1.5 text-xs font-semibold text-[#311EB2]">
                        ...
                        <td className="max-w-[300px] px-5 py-5 align-top">
                          ...
                          <p
                            className="line-clamp-4 text-sm leading-6 text-[#666]"
